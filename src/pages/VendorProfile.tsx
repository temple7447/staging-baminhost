...
import { vendors } from "@/components/estate/VendorGrid";
...
const VendorProfile = () => {
    const { id } = useParams();
    const vendor = useMemo(() => vendors.find(v => v.id === id), [id]);
        ...
        <div className="min-h-screen bg-slate-50/50">
            ...
            <div className="container mx-auto px-4 md:px-6 py-8 mt-20">
                ...
                <div className="flex items-center gap-2 text-xs text-slate-500 mb-8 overflow-hidden whitespace-nowrap">
                    ...
                    <span>/</span>
                    <span className="opacity-60">{vendor.role}s</span>
                    <span>/</span>
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="bg-white rounded-3xl p-6 md:p-8 border border-slate-100 shadow-sm flex flex-col md:flex-row gap-8 items-start">
                            <div className="relative w-32 h-32 md:w-40 md:h-40 flex-shrink-0">
                                <img src={vendor.avatar} alt={vendor.name} className="w-full h-full rounded-3xl object-cover" />
                            ...
                            <div className="flex-1 space-y-4">
                                <div className="flex flex-wrap items-center gap-3">
                                    ...
                                    <Badge variant="secondary" className="bg-blue-50 text-blue-600 hover:bg-blue-50 border-none font-black px-3 py-1">
                                        <Star className="w-3 h-3 fill-blue-600 mr-1" /> {vendor.rating} (128 reviews)
                                    </Badge>
                                </div>
                                <p className="text-slate-600 leading-relaxed italic max-w-xl">
                                    Professional {vendor.role.toLowerCase()} with 8+ years of experience in high-scale estate developments across Lagos. Specializing in sustainable architectural excellence and structural integrity.
                                </p>
